...
/**
 * Servlet implementation class AddAdditionalDriverServlet
 */
@WebServlet(urlPatterns = {"/addAdditionalDriver"})
public class AddAdditionalDriverServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddAdditionalDriverServlet() {
        super();
